...
class SignatureTests {
    ...
    data class Combo(val privateKey: String, val publicKey: String, val address: String, val jwtSig: String, val txSig: SignatureData)
    ...
    private val testData = arrayOf(
            ...
            Combo("4e1559a4ec4dff8e2369635fc936fce9281d3044f49b8acaacd935041b6ae785",
                    ...
                    SignatureData(v = 27, r = "TiyBsT+rragKtEbyeu5j0s3UBd1Mg1PhauWcz18FqR4=".decodeBase64().toBigInteger(), s = "H636/N3+JGbF8Vl6z/CjasA5H1glEWD8JYD+UOT8zn0=".decodeBase64().toBigInteger())),
            ...
            Combo("25692381beee3b4e85f2acf66ada03b10672db2113f91f9df94e90cce5d5a1ad",
                    ...
                    SignatureData(v = 27, r = "PTsUW/G8/e0ABwXIVZA/XHM4JDDQfLSCst6+MY49IjY=".decodeBase64().toBigInteger(), s = "IVxIsAt0Xn2Boc0j6V8uods+wZtH7LlwBbtpKQkVhfM=".decodeBase64().toBigInteger())),
            ...
            Combo("95b44703405c3a9a2dc24502d22681437390b6b5366548003a4cce8c0f0fe146",
                    ...
                    SignatureData(v = 27, r = "Y61Qgg1DNwJj7dcdtdvnfpmiz+2URlBo+UIBxJV5Vrw=".decodeBase64().toBigInteger(), s = "Ps4RL61fyom6akVXi65JaYeQnATMcKgrjmS5W8IKV3Q=".decodeBase64().toBigInteger())),
            ...
            Combo("efdd115c0ca8f5501ec03a2c4210343294956c898cd1fa4bae80d3ecc52b23db",
                    ...
                    SignatureData(v = 28, r = "y/u9o/qFhlFotjrSga+6MrTnilx+2kKGkV6f5SFAPUU=".decodeBase64().toBigInteger(), s = "HTxXWcd+RgBLzBPTqulW9FbPFdZUarRSLyszyPRVTqM=".decodeBase64().toBigInteger())),
            ...
            Combo("6a5e632c21700b25a99b391ae4ef034e08a7a192914d38b4655dd9058fe498df",
                    ...
                    SignatureData(v = 28, r = "PzXkY4KKSA9UTquF5S6W+FzE9jKeIGOXdWoawhfDMHY=".decodeBase64().toBigInteger(), s = "Xs7uQ5tp0djko4Hcq61SaEDYS+w2/HRuiuBNXw0ydBM=".decodeBase64().toBigInteger())),
            ...
            Combo("f93330497fe0d36e8e4fc39795ff8a82d5e4d388adb6c518c2582bfff2dae529",
                    ...
                    SignatureData(v = 28, r = "fm0RDNglR2FHKTnsy8v/4M81hb6rOKNYt5LyGM59s4c=".decodeBase64().toBigInteger(), s = "aCWKCCna/PaL0nUUCpeT+5LhGYd1bCyyZvjfVWu3sFU=".decodeBase64().toBigInteger())),
            ...
            Combo("01060240a4a4f38707482d9a5faf7fef6f9d5a93704598ed43759a4515a7004a",
                    ...
                    SignatureData(v = 28, r = "OFXjxx/u8tTA1w+Gjm4pPsIctT9kFHnqzcrJkG6Ms1g=".decodeBase64().toBigInteger(), s = "YEkiGBhLXFUZrSBQYF79Es1Z0TIlitq5sCobTqc0kO8=".decodeBase64().toBigInteger())),
            ...
            Combo("4ee10f8179f853314ad5814f9c8a12aa78b5173c93ca7cdd1731740403f413ca",
                    ...
                    SignatureData(v = 27, r = "zz6scur+3rVrLuZGwnVRy91DemUva3TjizG6r9dkvWc=".decodeBase64().toBigInteger(), s = "f4+JnvUpIwago5Zz+syugmdpfMhs4/OX9McQY21Qzbc=".decodeBase64().toBigInteger())),
            ...
            Combo("884c225a67e48935779f390db094818b7c2c0319f55c76cf62eb5b7a4df03f69",
                    ...
                    SignatureData(v = 28, r = "tUPJ2LRIaP5vPMJnzMYgb7zLcq7y6wPT0wBTrTAJ0w0=".decodeBase64().toBigInteger(), s = "ZyTMYjTyotr93l3LGjjaznINYjwnaB8KnLkg7ojogwk=".decodeBase64().toBigInteger())),
            ...
            Combo("019e0e384311b48e9ccc2750c0bd122e7e3b4db3d5c0a898b216068960f029fe",
                    ...
                    SignatureData(v = 28, r = "7apUh9aRFngt95KDQCW/weJVN6IYWWUVsIGm+TRgoL8=".decodeBase64().toBigInteger(), s = "fo97wNWLDcjWz6Uc9Lvh/lh9kuH6uPADGEw9o3oyKSQ=".decodeBase64().toBigInteger())),
            ...
            Combo("d003cd7071f4b3fe85256b4fa1046a1df20196b20b37869932dd28b9423e3f99",
                    ...
                    SignatureData(v = 28, r = "Gdbyqii1oykpU9R2sbgLfdrnAauvQrbVDQvkkFhjiyU=".decodeBase64().toBigInteger(), s = "e34dqk8rLKQYRKwuJKUzmPZiG9IS7lZbvhEc1kCiag8=".decodeBase64().toBigInteger())),
            ...
            Combo("20fe2194231bbbd237c94f3ffc55f4a94f536aa191b5cf026eb0d9ff20704371",
                    ...
                    SignatureData(v = 28, r = "MBCLYZlfUPVsW7Dtfa4UZ6zlamkXbFAGJJ536RjcWrk=".decodeBase64().toBigInteger(), s = "Gq/v7/xJzDcszwq3EdRrhe8iJpnvgRmNXzuNFH6Xdsc=".decodeBase64().toBigInteger())),
            ...
            Combo("2fb2eb84a45c5a6b0f0a69c4868ce0d6deab7ae376cfc88f19b08f920746f69d",
                    ...
                    SignatureData(v = 28, r = "fnMqglWNTqzdsHyxVM2Aq162m2Ps07Lf++nOmWB8utQ=".decodeBase64().toBigInteger(), s = "X/I2oeIG/04RRqt1L6dnslOksnQdBafadI2YQ6J1Whk=".decodeBase64().toBigInteger())),
            ...
            Combo("fccc238b12e9c296c0f96d9e48a7dd3c0d4df195f53720d079728b8e1cc28b17",
                    ...
                    SignatureData(v = 27, r = "ddmKEBYryK+DW1NhBQcz3HHS6j2JcY50x2G8Ceaq92Q=".decodeBase64().toBigInteger(), s = "BOzmcvwvX7eKWCjtZuu4ywP7jZ4pDo3FzopV4d+oRXQ=".decodeBase64().toBigInteger())),
            ...
            Combo("a7fec323144afe1c1773b38df6ba30604d86a85788855c0579fda0b1ab82404e",
                    ...
                    SignatureData(v = 27, r = "jP5yS00LOJABy7lTMA7eUjIUYnzsIfGsrGNsOXMd4ps=".decodeBase64().toBigInteger(), s = "dySgZteuxj3eD8WoBm0OEAf6WTtd8ETFkuvv03zsQic=".decodeBase64().toBigInteger())),
            ...
            Combo("19f99371c390cd8e70a0532c635e47e1355ceffda9c3bc8713d012ed03ec06e8",
                    ...
                    SignatureData(v = 27, r = "WxmjC71w2NBzLLZ3ZzapeYWeHNCT66Y9oLISYmF+bkc=".decodeBase64().toBigInteger(), s = "NIvLqlLrCptfmuQNtOy7k9ZUFPvcExi37JcxFog4F3U=".decodeBase64().toBigInteger())),
            ...
            Combo("62ce71798568e1f96495201a364e9670d399d97d8d5178398e3eb423dc0e7561",
                    ...
                    SignatureData(v = 27, r = "+IZ0+Qso0ZWPktRj9p8cXwM0vKfyy19AKl7tkayZ1uo=".decodeBase64().toBigInteger(), s = "Pcs3AXdXOMh2Gv26qEbqFKkKjha8HPEbU/vjJTzvoro=".decodeBase64().toBigInteger())),
            ...
            Combo("e44c40c7728078ae6339101f81bf5302fc075011abd80ba09f32bd3ed2d06f56",
                    ...
                    SignatureData(v = 28, r = "dTaLF/idookY+OnoJV1Fj+YXnY5sseAwI+x5FpK++kM=".decodeBase64().toBigInteger(), s = "Wj+kSEUFcuXMoEWGjFcQy/mr+1R34XozhB7omduoOM0=".decodeBase64().toBigInteger())),
            ...
            Combo("a8baaee5cc9de9c05e5eca19f24ffb2a02702b6f31cb456138ad641a324b15f1",
                    ...
                    SignatureData(v = 27, r = "b1ExJHRFB4pwCtINT3CdD6PF0BkmEI/6ikGOcgG9XXA=".decodeBase64().toBigInteger(), s = "GpoZH+rSnNHovTM8T/QZoZunFfaxI93gTmELeEpwfu8=".decodeBase64().toBigInteger())),
            ...
            Combo("7f505ebd23dadd2a01e1115be61f4ccb4e6f12f09eb7e9188ee21288f456e577",
                    ...
                    SignatureData(v = 27, r = "Y6lnfzUV7D+vpxLWvrfKOU6eF4ALX3sO+XOXs69Fg7I=".decodeBase64().toBigInteger(), s = "fcrAhssiT3Byjk7EW0XzleA+UhgE14BrHqgehQY/PWg=".decodeBase64().toBigInteger())),
            ...
            Combo("ee97e7658fbfc07c5bfb57fc5a14f6f6c97d6ac8e3f341c999883175c20fcf05",
                    ...
                    SignatureData(v = 27, r = "UiEf12c+nOx2qwIAC8u5wnw0czxcB/sPO215ZtypT+o=".decodeBase64().toBigInteger(), s = "MWMQpHAKq39DsbEsB1AGb+hDnN1gE8bcC2fODjaI3k4=".decodeBase64().toBigInteger())),
            ...
            Combo("be9d4fb5c681f75c55243b81bdcbf30ecc2d7e1b8c7a34195fb9775ab76fc2ef",
                    ...
                    SignatureData(v = 28, r = "FNzxaQ9nZTnlZOjY0qymUvvLKhd8gy6lJuj7bwIkDFI=".decodeBase64().toBigInteger(), s = "KM04QG5I0Rzqb5l9f7+sj6zbR/PuiubOBtTWEg2mD+A=".decodeBase64().toBigInteger())),
            ...
            Combo("3b0c49416d5ec9517e7870ab6566ac011da5ea5f011ddcff8e15d7cd0cd87328",
                    ...
                    SignatureData(v = 27, r = "O3UqbVGpe06GDrBM1KMO1Asci2hq0ucHN5MpzZHDuf0=".decodeBase64().toBigInteger(), s = "GGdS5fvplCcWTuzfQZ4s4swJu9hztPZ5Jwzn+a5Uw9s=".decodeBase64().toBigInteger())),
            ...
            Combo("0565790c4d0915c167c089ddd63cdf3016f1651d97bd52541494cd7834e7a739",
                    ...
                    SignatureData(v = 27, r = "F488AWPD4srfimiaF6oecFfrwSAXwRIMbDNBDapFrVg=".decodeBase64().toBigInteger(), s = "M/ntFoU/vhfLNFGrZUhFwd+WJ+AQvlA27mM4tVqVdYo=".decodeBase64().toBigInteger())),
            ...
            Combo("c8da839ad57a613d97c5e374d621f70b7b78902492da70f3ac271fe27d5652f2",
                    ...
                    SignatureData(v = 27, r = "2+F4WypEy/QLatF3sBW4zmVWadB3g5P5f0h5UeGK/Fk=".decodeBase64().toBigInteger(), s = "H1I+N1/X3BvirIHDhSaCDcgwsu9nX7YjEY23bhdrUOk=".decodeBase64().toBigInteger())),
            ...
            Combo("c995eab5513262c2822e15920b9064376d1b33f01b125e0d7093e7351e366d5e",
                    ...
                    SignatureData(v = 27, r = "cKUwmDelHTcpZCc2FSJJowKrRDYpFNtSSqL2k46VH0I=".decodeBase64().toBigInteger(), s = "P3E8AWzHcUeu8nXmBlzaJIomWtuIZc3OVM9qmxUJOSE=".decodeBase64().toBigInteger())),
            ...
            Combo("f0176976a08750d2ad33eb46f339511b1f23990c2b5a8c59574fa75bb3bc9aad",
                    ...
                    SignatureData(v = 28, r = "1GOzHHHiQZIkHCp++E5VDQ+gfpxHFv5YtIkclkhUH4c=".decodeBase64().toBigInteger(), s = "Xqd+ptV9/QpoHv8Z/ir5mVCscBYWvJEe/E4AS9nUE/E=".decodeBase64().toBigInteger())),
            ...
            Combo("313bc6445765165aca25f412475f3321842c270d9400f585d59bb8ed23167c1e",
                    ...
                    SignatureData(v = 28, r = "yAPxN8j8o/poHX/TTgIxm9GgWRCdX+D507w2nDWGyfQ=".decodeBase64().toBigInteger(), s = "fBXdhRO6X2wRJVIv9cbwlFgFk22Xh2V+znOCjMb8nCI=".decodeBase64().toBigInteger())),
            ...
            Combo("035d88da05943288a90581ddca5a3dacb068beb60602efa26ab61f91b202b098",
                    ...
                    SignatureData(v = 28, r = "4AOp+h/WWIYUyClst0ypx3yosxTFUvhQ11Cs95AomQg=".decodeBase64().toBigInteger(), s = "PbGvvjxw1H8GwumAKXjXcnIuz6U35scAa1WG/e9OTbI=".decodeBase64().toBigInteger())),
            ...
            Combo("c5f42cd60790e3d57f883a535f19902ee9515cf2f5e3031767499116e5ef0835",
                    ...
                    SignatureData(v = 28, r = "DxPStY6FhR1cMnrOY2355mtwz7Tbe2mUkToxL4zW+1I=".decodeBase64().toBigInteger(), s = "dgfh0dhqPM+QyeTg8TRx/o99YLQFloppP7IKs6dl5Io=".decodeBase64().toBigInteger())),
            ...
            Combo("18dc8bd93b827cdb2c03555ea1c25f641c14ca9e309aa4cc06c8c8a27682dbe1",
                    ...
                    SignatureData(v = 28, r = "K9/Xqq7SdUJsrAo9hJR7T9vNvztkIPTxG3VeNNmqtFQ=".decodeBase64().toBigInteger(), s = "aEYoLqpdqpdp5+RWcdB4k7nkpQrlXHVfRydH4NcJbQY=".decodeBase64().toBigInteger())),
            ...
            Combo("3dd60ce7a16cee8844304a3008e344a48802040f89aa37b5a8c644b3e03734a8",
                    ...
                    SignatureData(v = 27, r = "AnueK0BcFhcUZPLePAPyWQzWbkOX0TRjp9SYu+cWeD8=".decodeBase64().toBigInteger(), s = "LASEGyUukne5fc5dL1w+CX9aiDC5YUt+3oKsg5tGAEU=".decodeBase64().toBigInteger())),
            ...
            Combo("a0670660819203cc4cd606fb10e41964c88df593f10a7b3a6586a0c77cd7b788",
                    ...
                    SignatureData(v = 27, r = "z0l0N5ABmZwQwSMhHh4HhZoQF1Ngur2dAnghEFHYJ44=".decodeBase64().toBigInteger(), s = "AVfJYls7Wc/cKBlIs9jItTfTZbHFEdcqLvTRX5vLT0w=".decodeBase64().toBigInteger())),
            ...
            Combo("4058c4d945d175894a343593e20a7ea0e443bc7519f6e724cbfdff33caa1c417",
                    ...
                    SignatureData(v = 28, r = "4fpmukGxYAFV1kH3yofvQgrqwFSUHrTVehEQMPDkzJI=".decodeBase64().toBigInteger(), s = "Y8aS+SbZF+fBeA01jFPX58PsfoKaCQ8cy4csp0FyJLs=".decodeBase64().toBigInteger())),
            ...
            Combo("28f92893986f228df0701b671797de98692dbea624e9020ae90ca46324f1dbb8",
                    ...
                    SignatureData(v = 28, r = "W5+3rQKKjRGS9r+pooK5e7UULDM6JV13yAeP9bvj8/w=".decodeBase64().toBigInteger(), s = "QD8LIj2DzGMDKX5NYPvd4H4PeIHxRGr2JnZX9zLKRP4=".decodeBase64().toBigInteger())),
            ...
            Combo("538c6cf52b02f0197b3ab5ee0c4daf22d10d9e0481949bc9918216e89b17004b",
                    ...
                    SignatureData(v = 28, r = "C4/aYMZuqJr10ChbxMPEkBfrRXqJ8dl7ic7p/0zssdY=".decodeBase64().toBigInteger(), s = "BVFnSn8gVpJXOoHFmWiYv6chvuRQkTbyR84OpbwRBgQ=".decodeBase64().toBigInteger())),
            ...
            Combo("5ec82d04429686c9808db35b85d3a84db754f58bc46e0499dafefac308bc0a69",
                    ...
                    SignatureData(v = 28, r = "kzy2H/0+/UOyyuotaz2Xti4kwkqJHbvpag+0nhGYCTg=".decodeBase64().toBigInteger(), s = "CYvCL4+NuPSbWP5FulA6FM7MXsdbICN+E8PUiNPPukw=".decodeBase64().toBigInteger())),
            ...
            Combo("25f904bda7cf7d8ae422a3dc0a8b8b838714064deac36d0481f8e999d3b06318",
                    ...
                    SignatureData(v = 27, r = "kK6qJ3rfp1JTOBllEmHziyPyPzaDScu/UqYpLbaIwzs=".decodeBase64().toBigInteger(), s = "HqABQoNLa5aF6sppmPWuoKFrPQttMaRlsKx5j5JQ2mI=".decodeBase64().toBigInteger())),
            ...
            Combo("b3d9a71fcf70440e851e303e13851a89b35a5f37911d57ba0fb88627279f21a5",
                    ...
                    SignatureData(v = 28, r = "i+t2rOwZGZiaooevO9ftIo+gQqjRPsyE4G7sc1x5jrI=".decodeBase64().toBigInteger(), s = "fIxfJr0+rNzGrJOKCzX5o6/ohjYoC6DqORpoqVfI8h8=".decodeBase64().toBigInteger())),
            ...
            Combo("c87645ab6c562e4eccb6637a70750bb79e751ea68910b1dcbc49d6ccab721e2b",
                    ...
                    SignatureData(v = 27, r = "zQaCs3ADBkU21CHa1R1a8e55wI2E6m5Kk5zmMZI9Jm0=".decodeBase64().toBigInteger(), s = "WaF9VnW7dHPlpvXCus0/q2yASg/KxXN/SgsiAQdL6RQ=".decodeBase64().toBigInteger())),
            ...
            Combo("c69522947b9a0e9ee3151d207ce4c8273f14e2862f8957d128f4a54e7248e31c",
                    ...
                    SignatureData(v = 27, r = "fKWGAz9Muzz0p/2WQywx2wWaK6lAXAnQrsdYLqVScNQ=".decodeBase64().toBigInteger(), s = "QEHoyPgUb1u9u9oqQcc9l5eKBjB6YHFFmsXv/TCe68s=".decodeBase64().toBigInteger())),
            ...
            Combo("221c52e66ac846058181aea5e1d6379c4daa39887c744e03e0c1bf6b893f4375",
                    ...
                    SignatureData(v = 27, r = "3Hl4C5z9aHWeqzmFoB4RqEslaaTAzNfFbjKVoV2POqA=".decodeBase64().toBigInteger(), s = "KCrNtGK7Xv0DsNgAsJjrI+GVsMGlbfrAufCEMbx8Z5I=".decodeBase64().toBigInteger())),
            ...
            Combo("0b6bf54bec26d47b5313e725a3dd9fd39162d64b37d6fd773b0e789bd33b8b0d",
                    ...
                    SignatureData(v = 27, r = "JRXIRog2SYeudMIllMCDtxZ28kTeNGYPGAuVt9ccxaM=".decodeBase64().toBigInteger(), s = "IcA+VeL5NK6BuIvf/hwyXADWKzzTf0iQl/IoGFWzjo0=".decodeBase64().toBigInteger())),
            ...
            Combo("17c7465cd05dba8fea7045cba4ec344f1bfc2b03cdc6927dfeced97126a84f82",
                    ...
                    SignatureData(v = 28, r = "3DjCVrKJgwtFyUHRrondYjk23bDjEgqJAR+BHIDYM48=".decodeBase64().toBigInteger(), s = "VzQzMEpyO5yXgwwFB1oFG1vTFNp/OMdT66iuQ1UNScg=".decodeBase64().toBigInteger())),
            ...
            Combo("72255262378a076f766cd17ff015174df23f5c532a937c9bc03aa5b4e9afead8",
                    ...
                    SignatureData(v = 28, r = "YBDkYIYyOe8ynqdqsmIZUFpGctcrufMeNQgLFjvLZyE=".decodeBase64().toBigInteger(), s = "Ys1iqiBu2lEHbDbn92xxLfWPDu7XyShtUyGXqgAD5Qw=".decodeBase64().toBigInteger())),
            ...
            Combo("92465e3f17be18e01509254a10dff6ddf18d8651e091f3a045332cf896dda240",
                    ...
                    SignatureData(v = 27, r = "WW5ASMv5cMrXo94I2nqOAHDT6yArkG4+Zi9/VX76JGQ=".decodeBase64().toBigInteger(), s = "OWwuNMQ/nknmfcYBxsQIpLfPdX/SwO/RhZZkFVlRLvs=".decodeBase64().toBigInteger())),
            ...
            Combo("73391c9fbb1b79f7a53614a2ac13058bf08e62d299fe0afb48337be4f98d33ab",
                    ...
                    SignatureData(v = 27, r = "MDcNPEbo2UzVJeah0IVnp+CEJirkrdfQ2Xad2Ca3SQw=".decodeBase64().toBigInteger(), s = "N2K+BWZEDC8V76w1HnnL6GFKqHW3vRtUf+wyrdesDsE=".decodeBase64().toBigInteger())),
            ...
            Combo("d602f2d7c4845a7b64fede9c79eb7367661e2299b877457cf957095c38ab1d9f",
                    ...
                    SignatureData(v = 28, r = "x/Wa9zE1gEgHBceTTjoNHkGMXl+jzavoHWf/T9N5tIw=".decodeBase64().toBigInteger(), s = "fq8vzjGLlcPjZmX47uoom6jqethXVDzgPfE9/vISXAc=".decodeBase64().toBigInteger())),
            ...
            Combo("1e029460a97d52117f66b09e25d69eaf0a03cceefd160c089ef067b6708d014b",
                    ...
                    SignatureData(v = 27, r = "BYeNaKRco0ngGgdpn8rHxpDtLEN4ZPoCisYfp1aFIZw=".decodeBase64().toBigInteger(), s = "QgJuTHJASMS3eRS/9Wh3wrdZrSxr+eZ7ZS4mr88It2U=".decodeBase64().toBigInteger())),
            ...
            Combo("5499ea955c098840775cd627ea4fc93d8f3de17f8721a93be3ebe3b7b70b4fcc",
                    ...
                    SignatureData(v = 28, r = "N3CIZNI0Cbma3HvyFwNjj+wTlt3FdMHqEgTkPJxjC+c=".decodeBase64().toBigInteger(), s = "CiDhJ1ZOvJVdMsW98Z03EcNFlr/eecOBUsgmcIC5wDM=".decodeBase64().toBigInteger())),
            ...
            Combo("818b285cf19c5fbd3d5a02b307d05132ef204d60dae8eff59535d03cbb63c932",
                    ...
                    SignatureData(v = 27, r = "QWv2w5Mma5RncmBJst1UsBtA8IwWJV4UI9V9AqETcqI=".decodeBase64().toBigInteger(), s = "PZrS9WhDochBeH6DqlCgnqb2tHmIjIZjm8+Av0Lxr/0=".decodeBase64().toBigInteger()))
