...
class SignatureTests {
    ...
    fun `signature format matches`() = runBlocking {
        ...
        val refJwtMessage = "eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NksifQ.eyJpc3MiOiIzNHdqc3h3dmR1YW5vN05GQzh1ak5KbkZqYmFjZ1llV0E4bSIsImlhdCI6MTQ4NTMyMTEzMywiY2xhaW1zIjp7Im5hbWUiOiJCb2IifSwiZXhwIjoxNDg1NDA3NTMzfQ"
        ...
        testData.forEach { ref ->
            ...
            val sig = signer.signJWT(refJwtMessage.toByteArray(utf8))
