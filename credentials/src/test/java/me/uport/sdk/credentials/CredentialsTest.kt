...
class CredentialsTest {
    ...
    fun `create basic verifiable credential`() = runBlocking {
        ...
        assertThat(jwt).isEqualTo("eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NksifQ..Af2by3Ar7ZOK-a_fkCYr45PZ81lXGKM2ruB0Io5loQJ9k48Qz8jt5eusiukxrxQRDFLHd4LBPSfzoMDNbAX72A")
    }
    ...
    fun `create basic verifiable presentation`() = runBlocking {
        ...
        assertThat(presentation).isEqualTo(
            "eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NksifQ..UeLoqTYxTdTs6fQ4RCc6vb-5hyujB1ioUc5cas_r4tLXYK5WX4QOm77rrUaTLD3M2HzOB_gsxzT75AmwWOVHWA"
        )
    }
